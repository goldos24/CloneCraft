...
namespace oldf {
	...
	namespace glu
	{
        ...
        int Project(GLdouble objx, GLdouble objy, GLdouble objz, GLdouble* modelview, GLdouble* projection, GLint* viewport, float& windowCoordinateX, float& windowCoordinateY, float& windowCoordinateZ)
        {
